...
## Recent Changes
- 002-core-data-model: Added Dart 3.x (Flutter SDK 3.32.0) + Drift (local SQLite ORM), Serverpod ORM (cloud PostgreSQL ORM), drift_dev (code generation)

- 001-workspace-foundation: Added Dart 3.x (Flutter SDK latest stable, Serverpod latest stable) + Flutter, Serverpod, Drift, flutter_riverpod, connectivity_plus, go_router, flutter_localizations
