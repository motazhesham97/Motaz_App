...
d = r"D:\Motaz_App2\motaz_app\motaz_app_server\lib\src\services"
...
all_sections = [
    imports, parse_parent, validate_device, check_row_version,
    load_entity_row, classify_changed, apply_auto_merge,
    emit_conflict, accept_mutation, query_changed, get_pending,
    private_methods, entity_table_map, column_allowlist,
    auto_merge_fields, conflict_fields,
]

content = "\n".join(line for section in all_sections for line in section) + "\n"

outpath = os.path.join(d, "sync_service.dart")
with open(outpath, "w", encoding="utf-8", newline="\n") as f:
    f.write(content)
print(f"OK: {len(content)} chars -> {outpath}")
