...
--
-- Class Beneficiary as table beneficiary
--
...
CREATE TABLE "client" (
    ...
    "clientCode" text,
    "creditLimit" bigint,
    "invoiceCheckIntervalDays" bigint,
    "isActive" boolean NOT NULL DEFAULT true,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL,
    "deviceId" uuid NOT NULL,
...
CREATE TABLE "device" (
    ...
    "nextSampleSequence" bigint NOT NULL DEFAULT 1,
    "createdAt" timestamp without time zone NOT NULL,
...
--
-- Class FreeSample as table free_sample
--
...
--
-- Class FreeSampleLine as table free_sample_line
--
...
--
-- Class PartyAdjustment as table party_adjustment
--
...
--
-- Foreign relations for "beneficiary" table
--
...
--
-- Foreign relations for "free_sample" table
--
...
--
-- Foreign relations for "free_sample_line" table
--
...
--
-- Foreign relations for "party_adjustment" table
--
