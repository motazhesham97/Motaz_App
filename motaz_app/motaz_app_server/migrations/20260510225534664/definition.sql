...
-- Indexes
CREATE INDEX "monthly_distribution_year_month_idx" ON "monthly_distribution" USING btree ("year", "month");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('motaz_app', '20260510225534664', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260510225534664', "timestamp" = now();
