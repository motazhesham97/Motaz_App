...
import '../../features/clients/presentation/placeholder_screen.dart';
...
import '../../features/products/presentation/placeholder_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/products', builder: (context, state) => const ProductsPlaceholderScreen()),
      GoRoute(path: '/clients', builder: (context, state) => const ClientsPlaceholderScreen()),
